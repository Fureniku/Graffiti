...
import com.silvaniastudios.graffiti.client.gui.DrawableList;
...
public class TextMenu extends GuiCanvasEditorBase {
	...
	private void initButtons() {
		...
		textList = new DrawableList(this.minecraft, 242, 100, startY + 141, startY + 241, 12);
		System.out.println("text list created at " + (startY + 141) + ", " +  (startY + 241));
	}
	...
	protected void init() {
		...
		textList.populateList(tileEntity.textList);
	...
	public void render(int mouseX, int mouseY, float partialTick) {
		...
		textList.render(mouseX, mouseY, 0);
	}
